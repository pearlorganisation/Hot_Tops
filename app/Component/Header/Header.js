...
function Header() {
  ...
  return (
    <>
      <section>
        <div className="relative w-full bg-gradient-to-br from-orange-400 to-yellow-400  text-white">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
            <div className="inline-flex items-center space-x-2">
              <span>
                <img
                  src="https://mma.prnewswire.com/media/996668/Pizza_Hut_Logo.jpg?p=facebook "
