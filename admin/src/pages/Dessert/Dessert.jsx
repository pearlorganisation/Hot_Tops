...
const Dessert = () => {
    ...
    const {isDeleted, dessertData,isLoading } = useSelector(state => state.dessert)
    
    const handleAddCategory = () => {
        navigate('/createDessert');
      };
        ...
        <div className="max-w-screen-xl mx-auto px-4 md:px-8 mt-4">
          <div className="items-start justify-between md:flex">
            <div className="max-w-lg">
              ...
              This page is for handle dessert by create , update and delete
              </p>
            </div>
            ...
            <table className="w-full table-auto text-sm text-left">
              <thead className="bg-gray-50 text-gray-600 font-medium border-b">
                <tr>
                  ...
                  <th className="py-3 px-6">Dessert </th>
              ...
              <td colSpan="6" className="text-center px-6 py-8">
                <Stack spacing={4}>
                 ...
                 Array.isArray(dessertData) && dessertData.length > 0 && dessertData?.map((item, idx) => (
                    <tr key={idx}>
