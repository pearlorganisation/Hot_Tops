...
import { deleteFilter, getFilter } from '../../../features/actions/sides/filterSides'
...
const Filter = () => {
    ...
    const {isDeleted,filterData,isLoading } = useSelector(state => state.sidesFilter)
  
    
    const handleAddFilter = () => {
      navigate('/createSidesFilter');
      };
        ...
        <div className="max-w-screen-xl mx-auto px-4 md:px-8 mt-4">
          <div className="items-start justify-between md:flex">
            <div className="max-w-lg">
              ...
              This page is for handle sides filter by create, update and delete
              </p>
            </div>
                 ...
                 Array.isArray(filterData) && filterData.length > 0 && filterData?.map((item, idx) => (
                    <tr key={idx}>
                      ...
                      <td className=" whitespace-nowrap">
                        <a
                          onClick={() => {
                            navigate(`/updateSidesFilter/${item?._id}`, { state: item  });
                          }}
