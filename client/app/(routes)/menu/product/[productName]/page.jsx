...
const Product = () => {
  ...
  useEffect(() => {
    dispatch(setDefaultPrice([cheesePrices, saucePrices, vegetarianToppingsPrices, meatToppingsPrices].flat()))
  }, [cheesePrices, saucePrices, vegetarianToppingsPrices, meatToppingsPrices])
